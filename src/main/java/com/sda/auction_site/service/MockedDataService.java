...
public class MockedDataService {
    ...
    public void initFakeData(){
        ...
        try{
            ...
            Category category2 = new Category(0L,"Old Cars","",Collections.emptyList());
            Category category3 = new Category(0L,"Real Estate","",Collections.emptyList());
            Category category4 = new Category(0L,"Art","",Collections.emptyList());
            Category category5 = new Category(0L,"Watches","",Collections.emptyList());
            List.of(category,category1,category2,category3,category4,category5).forEach(categor -> {
